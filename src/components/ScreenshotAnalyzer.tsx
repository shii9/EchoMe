  ...
  const analyzeScreenshot = async () => {
    ...
    try {
      ...
      if (extractedText) {
        ...
        toast.error('No text could be extracted from the image. Please try another one.');
      }
    } catch (error) {
    ...
    <Card className="p-6 bg-gradient-card border-border">
      ...
      {!image ? (
        ...
        >
          ...
          <span className="font-medium text-muted-foreground">Upload or drag and drop Email Screenshot</span>
