...
export const IPScreenshotAnalyzer = ({ onAnalyze }: { onAnalyze: (text: string) => void }) => {
  ...
  const analyzeScreenshot = async () => {
    ...
    try {
      ...
      if (extractedText) {
        ...
        toast.success('Screenshot analyzed! IP text extracted and ready for analysis.');
      } else {
  ...
  return (
    <Card className="p-6 bg-gradient-card border-border">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-lg font-semibold">IP Screenshot Analysis</h3>
      </div>
      ...
      {!image ? (
        ...
        >
          ...
          <span className="font-medium text-muted-foreground">Upload or drag and drop IP Details Screenshot</span>
        ...
        >
          <div className="relative rounded-lg overflow-hidden border border-border">
            <img src={image} alt="IP Details Screenshot" className="w-full h-auto" />
          </div>
